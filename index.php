...
<div>
	...
	<form id="sub_form" method="get" action="index.php" promptpermission="offline_access, create_event">
		<p>You can subscribe to a calendar which supports the <a href="http://en.wikipedia.org/wiki/ICalendar" target="_blank">iCalendar format</a>. This calendar will then be periodically checked for new events. <a href="http://www.facebook.com/apps/application.php?v=info&id=164414672850" target="_blank">Help</a></p>
	<div id="fields">
		<div class="box">
			<div class="inputs">
		...
		<div class="box"><p>Facebook requires you to assign a category and subcategory to your events. Choose those that best fit your calendar.</p>
			...
			<div id="options" style="display:none;">
				...
				<div class="adv_opt">
					<h4>Group/Page</h4>
					<p>If you want to create these events for a facebook group or (fan-)page, enter its ID here. (<a href="http://www.facebook.com/apps/application.php?v=info&id=164414672850" target="_blank">What is an ID</a>?)</p>
				...
				<div class="adv_opt">
					<h4>Wall</h4>
					<input type="checkbox" name="wall" />Publish events on your profile (or that of a page/group)<br/>
				</div>
                                ...
                                <div class="bottom_box">
                                    ...
                                    <div id="adv_msg_div">
                                        ...
                                        echo '<p>If you selected a picture or chose <i>Wall</i> you need to give the app <fb:prompt-permission perms="publish_stream">permission to publish</fb:prompt-permission>.</p>';
                                        }
                                        ?>
                                    </div>
